[spark-procedural-animations](README.md) / Exports
...
- [lookAt\_lt\_dn](modules.md#lookat_lt_dn)
...
| `isRight` | `boolean` |
| `nodes` | [`IkNode`](classes/IkNode.md)[] |
...
▸ **fromRangeTo01Clamped**(`xOfRange`, `xMin`, `xMax`): `number`
...
▸ **movAvg**(`lastAverage`, `current`, `count`): `number`
